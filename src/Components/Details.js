                                        ...
                                        return <li key={index}>
                                            <div className="row no-gutters menuItem">
                                                ...
                                                <div className="col-2">
                                                    ...
                                                    {/* <button className="add-button" onClick={() => this.addItemHnadler(index, 'add')}>Add</button> */}
                                                     <div className="add-number"> 
                                                     <br/>
                                                     
                                                        <button class="btn btn-light btn-sm" onClick={() => this.remove(item )}>-</button>
                                              
                                                        <span class="qty">{item.qty}</span>
                                                        <button  class="btn btn-light btn-sm" onClick={() => this.addItemHnadler(item)}>+</button>
                                                    </div>
                                                </div>
